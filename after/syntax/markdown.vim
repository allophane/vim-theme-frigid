...
" plasticboy/vim-markdown {{{1
  hi! link mkdBlockquote   FrigidMutedItalic
  hi! link mkdBold         FrigidBold
  hi! link mkdDelimiter    Keyword
  hi! link mkdItalic       FrigidItalic
  hi! link mkdListItem     Keyword
  hi! link mkdListItemLine FrigidNormal
...
" Builtin: {{{1
  ...
  hi! link markdownBold              FrigidBold
  hi! link markdownHeadingDelimiter  Keyword
  hi! link markdownIdDelimiter       Keyword
  hi! link markdownItalicDelimiter   Keyword
  hi! link markdownItalic            FrigidItalic
  hi! link markdownLinkDelimiter     Keyword
  hi! link markdownLinkTextDelimiter Keyword
  hi! link markdownLinkText          FrigidNormal
  hi! link markdownListMarker        Keyword
  hi! link markdownRule              Keyword
  hi! link markdownH1                FrigidBold
